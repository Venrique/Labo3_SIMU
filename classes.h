...
enum parameters {THERMAL_CONDUCTIVITY_ONE,THERMAL_CONDUCTIVITY_TWO,HEAT_SOURCE};
...
class mesh{
    ...
    public:
        void setParameters(float E,float A,float f){
            parameters[THERMAL_CONDUCTIVITY_ONE]=E;
            parameters[THERMAL_CONDUCTIVITY_TWO]=A;
